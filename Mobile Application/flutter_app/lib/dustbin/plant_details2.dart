...
class PlantDetails2 extends StatefulWidget {
  const PlantDetails2({super.key});

  @override
  State<PlantDetails2> createState() => _PlantDetails2State();
}

class _PlantDetails2State extends State<PlantDetails2> {
